 ...
 */
package pbo2.pkg10118059.latihan29warnakepribadian;
 ...
 * Kelas : IF-2
 */
public class PBO210118059Latihan29WarnaKepribadian {
    ...
    public static void main(String[] args) {
        System.out.println( RED + "YUK " + GREEN + "CEK " + YELLOW + "KEPRIBADIANMU " + CYAN + "DARI " + MAGENTA + "WARNA " + BLUE + "FAFORITMU" + NORMAL);
        ...
        String warnaFav = input.nextLine();
        String fav = warnaFav.toUpperCase();
        ...
        if (fav.equalsIgnoreCase("biru")){
            ...
            } else if (fav.equalsIgnoreCase("merah")){ 
